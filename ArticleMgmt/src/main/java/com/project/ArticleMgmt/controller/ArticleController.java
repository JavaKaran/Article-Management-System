package com.project.ArticleMgmt.controller;
...
import com.project.ArticleMgmt.repository.ArticleRepository;
...
public class ArticleController {
  ...
  @GetMapping("/articles")
  public ResponseEntity<List<Article>> getAllTutorials(@RequestParam(required = false) String title) {
    try {
